...
%     end
%     subplot(2,3,1), imshow(abs(im)), title("m(x,y)");
%     subplot(2,3,2), imshow(abs(m_pk)), title("m_p_k(x,y)");
%     subplot(2,3,4), imshow(M), title("M(k_x,k_y)");
%     subplot(2,3,5), imshow(fft2c(m_pk)), title("M_p_k(k_x,k_y)");
%     subplot(2,3,3), imshow(abs(abs(im)-abs(m_pk))), title("||m(x,y)|-|m_p_k(x,y)||");
%     subplot(2,3,6), imshow(abs(abs(im)-abs(m_pk))*5), title("||m(x,y)|-|m_p_k(x,y)||x5");
%--------------------------------------------------------------------------
